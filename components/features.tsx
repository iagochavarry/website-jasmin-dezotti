        ...
        <div className="border-t border-[var(--color-accent)] py-12 md:py-20">
          ...
          <div className="mx-auto grid max-w-sm gap-6 sm:max-w-none sm:grid-cols-2 md:gap-6 lg:grid-cols-3">
            <article className="group p-6 rounded-xl bg-white border border-[var(--color-accent)] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[var(--color-primary)]/10 group-hover:bg-[var(--color-primary)]/20 group-hover:scale-110 transition-all duration-300">
                <svg
